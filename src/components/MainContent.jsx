...
const toggleRole = useStore((state) => state.toggleRole)
  ...
  return (
    <main className="flex-1 p-4 ">
      {/* Header */}
      <header className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white flex justify-between items-center p-4 ">
        ...
        <div className="flex gap-3 p-2"> 
          ...
          {/* Toggle Theme */}
        <button onClick={toggleTheme}> {theme==="dark"?<Sun size={18}/>:<MoonStar size={18}/> }
        </button>
         
         {/* RoleBased-- */}
          <button onClick={toggleRole}> {role==="admin"?<User size={18}/>:<UserPlus size={18}/>}
        </button>
      ...
      {/* Cards */}
      <div className="grid  grid-cols-1 md:grid-cols-3 gap-4 bg-white dark:bg-gray-900 text-gray-800 dark:text-white ">
    ...
    {/* Charts */}
     ...
     <div className="bg-white p-4 rounded-xl shadow lg:col-span-2 space-y-4 dark:bg-gray-900 text-gray-800 dark:text-white ">
    <BarChart />
     <DoughnutChart />
  </div>
