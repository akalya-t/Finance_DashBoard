...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-white shadow-md transform transition-transform duration-300 dark:bg-gray-900 text-black dark:text-white 
      ...
      >
        ...
        <div className="absolute bottom-0 w-full p-4">
          <div className="flex items-center justify-between bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded">
